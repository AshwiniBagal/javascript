...
let avgSalary = count/ countOfWiproEmp;
    console.log(`Avg salary of employee from company wipro: ${avgSalary}`);
...
console.log( `Avarage salary of employees from companys Wipro and Infy : ${avgSalaryIs}`  );
