...
for (const elem of arrayEmployees) {
    if(elem.emp_company =="TCS"){
     console.log(`Employee Name:${elem.emp_name} , Company : ${elem.emp_company}`);
    }
...
console.log("===================Step2===========================");
for (const elem of arrayEmployees) {
    if(elem.emp_dept=="Finance"){
     console.log(`Employee Name:${elem.emp_name} , Department : ${elem.emp_dept}`);
    }
...
console.log("===================Step 4===========================");
for (const elem of arrayEmployees) {
    if(elem.emp_salary > 75000){
     console.log(`Employee Name:${elem.emp_name} , Company : ${elem.emp_company} , Salary:${elem.emp_salary}`);
    }
...
for (const elem of arrayEmployees) {
    if(elem.emp_salary >= 50000 && elem.emp_dept =="IT"){
     elem.getDetails();
    }
